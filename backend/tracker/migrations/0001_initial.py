# Generated by Django 4.2.19 on 2025-08-07 01:36
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alert_type', models.CharField(choices=[('suspicious_user', 'Suspicious User Detected'), ('high_risk', 'High Risk Activity'), ('pattern_detected', 'Pattern Detected'), ('threshold_exceeded', 'Threshold Exceeded'), ('law_enforcement', 'Law Enforcement Alert'), ('system', 'System Alert')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case_type', models.CharField(choices=[('missing', 'Missing'), ('murdered', 'Murdered')], max_length=20)),
                ...
                ('law_enforcement_contact', models.CharField(blank=True, max_length=255)),
                ('total_views', models.IntegerField(default=0)),
                ('unique_visitors', models.IntegerField(default=0)),
                ('suspicious_visitors', models.IntegerField(default=0)),
                ('tips_received', models.IntegerField(default=0)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='sessions', to='tracker.case')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='tracking_events', to='tracker.case')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('case', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='suspicious_activities', to='tracker.case')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('associated_cases', models.ManyToManyField(blank=True, to='tracker.case')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='case',
            index=models.Index(fields=['slug'], name='cases_slug_d8764a_idx'),
        ),
        migrations.AddIndex(
            model_name='case',
        ...
        migrations.AddField(
            model_name='alert',
            name='case',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='alerts', to='tracker.case'),
        ),
        migrations.AddField(
            model_name='alert',
            name='resolved_by',
        ...
        migrations.AddField(
            model_name='alert',
            name='session',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tracker.usersession'),
        ),
        migrations.AddField(
            model_name='alert',
            name='suspicious_activity',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='tracker.suspiciousactivity'),
        ),
        migrations.AddIndex(
