# cases/urls.py - Updated URL configuration with all endpoints including image upload
...
Custom Case Actions:
POST   /cases/{id}/upload_victim_photo/     - Upload victim photo
...
PUT    /case-photos/{id}/                   - Update photo
PATCH  /case-photos/{id}/                   - Partial update
