...
/**
 * API methods organized by resource (from base44Client)
 */
...
export const authUtils = {
  ...
  /**
   * Set access token (stores in all compatible keys)
   */
  ...
  /**
   * Clear all auth data and tokens
   */
  ...
  /**
   * Check if on preview route (exposed for other parts of app)
   */
 ...
 * These maintain compatibility with existing code that might use old imports
 */
export const base44API = apiMethods;  // Alias for compatibility with base44Client
export const getAccessToken = authUtils.getAccessToken;  // For compatibility
export const setAccessToken = authUtils.setAccessToken;  // For compatibility
export const isAuthenticated = authUtils.isAuthenticated;  // For compatibility
